...
-- 用户和岗位系表
DROP TABLE IF EXISTS t_user_position_relation;
CREATE TABLE t_user_position_relation
(
    id           VARCHAR(20) PRIMARY KEY COMMENT 'id',
    user_id      VARCHAR(20)  NOT NULL COMMENT '用户id',
...
-- 用户
INSERT INTO t_users (id, username, password, deleted, enabled, account_non_expired, credentials_non_expired, account_non_locked, name, mobile, created_time, updated_time, created_by, updated_by)
VALUES
(101, 'admin', '$2a$10$vYA9wKn/hVGOtwQw2eHiceeIGNBdfLYpDmbzHgBSVmOfHXPH4iYdS', 'N', true, true, true, true,
 '超级管理员', '', now(), now(), 'system', 'system'),
(102, 'starrk', '$2a$10$vYA9wKn/hVGOtwQw2eHiceeIGNBdfLYpDmbzHgBSVmOfHXPH4iYdS', 'N', true, true, true, true,
 '刘士增', 15619841000, now(), now(), 'system', 'system');
-- 角色
INSERT INTO t_roles (id, code, name, description, created_time, updated_time, created_by, updated_by)
...
-- 资源
INSERT INTO t_resource (id, name, code, type, url, method, description, created_time, updated_time, created_by, updated_by)
...
-- 用户关系授权
INSERT INTO t_user_role_relation (id, user_id, role_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 102, 101, now(), now(), 'system', 'system'),
       (103, 102, 103, now(), now(), 'system', 'system');
-- 角色与资源关系表
INSERT INTO t_role_resource_relation (id, role_id, resource_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
...
-- 岗位
INSERT INTO t_position (id, name, description, created_time, updated_time, created_by, updated_by)
...
-- 菜单
INSERT INTO t_menu (id, parent_id, type, href, icon, name, description, order_num, created_time, updated_time, created_by, updated_by)
...
INSERT INTO t_user_group_relation (id, user_id, group_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 102, 101, now(), now(), 'system', 'system');
INSERT INTO t_user_position_relation (id, user_id, position_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 103, now(), now(), 'system', 'system'),
       (102, 102, 103, now(), now(), 'system', 'system');
-- 角色关系表
INSERT INTO t_role_menu_relation (id, role_id, menu_id, created_time, updated_time, created_by, updated_by)
VALUES (101, 101, 101, now(), now(), 'system', 'system'),
       (102, 101, 102, now(), now(), 'system', 'system'),
       (103, 101, 103, now(), now(), 'system', 'system'),
