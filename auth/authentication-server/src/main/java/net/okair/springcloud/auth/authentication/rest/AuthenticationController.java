...
import net.okair.springcloud.auth.authentication.service.IAuthenticationService;
...
public class AuthenticationController {
    ...
    public Result decide(@RequestParam String url, @RequestParam String method, HttpServletRequest request) {
        boolean decide = authenticationService.decode(new HttpServletRequestAuthWrapper(request, url, method));
